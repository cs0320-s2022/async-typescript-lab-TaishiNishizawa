...
const sunVal = document.querySelector("#sun");
const moonVal = document.querySelector("#moon");
const risingVal = document.querySelector("#rising");
...
document.addEventListener("keyup", (keyEntry) => {
    if (keyEntry.key == "q") {
